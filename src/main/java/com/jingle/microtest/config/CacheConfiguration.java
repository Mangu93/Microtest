package com.jingle.microtest.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.jingle.microtest.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.jingle.microtest.repository.UserRepository.USERS_BY_EMAIL_CACHE);
